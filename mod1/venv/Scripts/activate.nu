...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Михаил\PycharmProjects\FlaskProject\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Михаил\PycharmProjects\FlaskProject\venv\Scripts\deactivate.nu'
